...
abstract class AppLocalizations {
  ...
  /// No description provided for @couponCodeTitle.
  ///
  /// In en, this message translates to:
  /// **'Coupon code'**
  String get couponCodeTitle;

  /// No description provided for @couponLockedDescription.
  ///
  /// In en, this message translates to:
  /// **'Complete all achievements to unlock your coupon.'**
  String get couponLockedDescription;

  /// No description provided for @couponUnlockedDescription.
  ///
  /// In en, this message translates to:
  /// **'You unlocked a reward of {amount} ALL.'**
  String couponUnlockedDescription(int amount);

  /// No description provided for @revealCoupon.
  ///
  /// In en, this message translates to:
  /// **'Reveal coupon'**
  String get revealCoupon;
  ...
  /// No description provided for @rewardAlreadyRedeemed.
  ///
  /// In en, this message translates to:
  /// **'Reward already redeemed.'**
  String get rewardAlreadyRedeemed;

  /// No description provided for @couponRevealedSnack.
  ///
  /// In en, this message translates to:
  /// **'Coupon revealed: {code} (+{amount} ALL)'**
